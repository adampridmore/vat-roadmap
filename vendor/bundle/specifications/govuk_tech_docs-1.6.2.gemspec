# -*- encoding: utf-8 -*-
# stub: govuk_tech_docs 1.6.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_dependency(%q<middleman-search>.freeze, [">= 0"])
      s.add_dependency(%q<nokogiri>.freeze, [">= 0"])
      s.add_dependency(%q<redcarpet>.freeze, ["~> 3.3.2"])
      s.add_dependency(%q<openapi3_parser>.freeze, [">= 0"])
      s.add_dependency(%q<pry>.freeze, [">= 0"])
      s.add_dependency(%q<bundler>.freeze, ["~> 1.15"])
      s.add_dependency(%q<rake>.freeze, ["~> 10.0"])
      s.add_dependency(%q<capybara>.freeze, ["~> 2.18.0"])
      s.add_dependency(%q<govuk-lint>.freeze, ["~> 3.7.0"])
